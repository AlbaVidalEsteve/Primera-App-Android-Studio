...
class CategoriesViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    private val viewConteiner: CardView = view.findViewById(R.id.viewContainer)

    fun render(taskCategory: TaskCategory, onItempSelected: (Int) -> Unit) {
        ...
        itemView.setOnClickListener { onItempSelected(layoutPosition) }
